...
def evalue_all(mat_file,wisppn):
    ...
    Mconv7_stage6_L1,Mconv7_stage6_L2,paf3,pcm3,paf2,pcm2,paf1,pcm1 = wisppn(csi_data,csi_data,csi_data)
    ...
    for key, value in coords.items():
        if value:  # 检查列表是否非空
            #print('quanbu:', value)
            # 根据置信度选择最高的元素
            max_item = max(value, key=lambda item: item[2])
            x, y, *_ = max_item  # 提取置信度最高元素的x和y坐标
            #print('CAIyong:', x, y)
        else:
            x, y = 0, 0  # 空列表时，记录为0
...
if __name__=="__main__":
    ...
    torch.save(wisppn, '0423weights/wisppn-20250428-nt.pth')
    ...
    #wisppn.load_state_dict(torch.load('0423weights/wisppn-20250427-epoch189.pth'))
    wisppn.load_state_dict(torch.load('0423weights/wisppn-20250428-nt.pth'))
    ...
    #wisppn = torch.load('weights2/wisppn-20251028-epoch55.pkl').eval()

    mats = []
    mats1 = []
    
    
    #mats += glob.glob('/home/qyy/notebooks/output_label150_2024_11_30_*/group2_30_percent/*.mat')
    mats += glob.glob('/home/qyy/notebooks/0329dataset/output_label150_2025_03_29_*/test/*.mat')
    #mats += glob.glob('/home/qyy/notebooks/0329dataset/output_label150_2025_03_29_*_with_zeros/test/*.mat')
    print(len(mats))
    ...
    mats += glob.glob('/home/qyy/notebooks/group2_30_percent_push/*.mat')33333

...
class rtpose_modelST4(nn.Module):
    def __init__(self, model_dict):
        super(rtpose_modelST4, self).__init__()
        #self.tf1 = ChannelTransformer_OPP(vis=False, img_size=[36, 36], channel_num=185, num_layers=1, num_heads=3)
        #self.tf2 = ChannelTransformer_OPP(vis=False, img_size=[36, 36], channel_num=185, num_layers=1, num_heads=3)
        #self.tf3 = ChannelTransformer_OPP(vis=False, img_size=[36, 36], channel_num=185, num_layers=1, num_heads=3)
        #self.model0 = model_dict['block0']
        self.cbam1 = CBAM(gate_channels=57)
        self.cbam2 = CBAM(gate_channels=57)
        self.cbam3 = CBAM(gate_channels=57)
        self.model1_1 = model_dict['block1_1']
        self.model2_1 = model_dict['block2_1']
        self.model3_1 = model_dict['block3_1']
        self.model4_1 = model_dict['block4_1']
    ...
    def forward(self, x , st1 , st2):
        ...
        out3_1 = self.model3_1(out3)
        out3_2 = self.model3_2(out3)
        out4 = torch.cat([out3_2, out3_1], 1)
        out4_weight = self.cbam3( out4)
        out4 = out4_weight*out3
        #out4 = self.tf3(out4)
        ...
        return out4_1, out4_2, out3_1, out3_2, out2_1, out2_2, out1_1, out1_2
    def _initialize_weights_norm(self):
...
class rtpose_model_STAGE1(nn.Module):
    def __init__(self, model_dict):
        super(rtpose_model_STAGE1, self).__init__()
...
def get_model_stage1():
    ...
    model = rtpose_model_STAGE1(models)
    # 冻结所有参数
    #for param in model.parameters():
        #param.requires_grad = False
    return model
